...
public:
	...
	void rotateLeft(int spd);					// Rotation vers la gauche autour du centre de l'axe des roues. Vitesse réduite fixe
	void rotateRight(int spd);					// Rotation vers la droite autour du centre de l'axe des roues. Vitesse réduite fixe
